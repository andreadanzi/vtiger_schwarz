...
class ProjectTask extends CRMEntity {
    ...
    var $list_fields = Array (
        ...
        'Procedura'=>Array('projecttaskcf','cf_660'),
        'Ente'=>Array('projecttask','publicadminid'),
        'Data Presentazione'=> Array('projecttaskcf', 'cf_657'),
        'Data Protocollo'=> Array('projecttaskcf', 'cf_658'),
    ...
    var $list_fields_name = Array(
        ...
        'Procedura'=>'cf_660',
        'Ente'=>'publicadminid',
        'Data Presentazione'=>'cf_657',
        'Data Protocollo'=> 'cf_658',
    ...
    var $search_fields = Array(
        ...
        'Project Task Name'=> Array('projecttask', 'projecttaskname'),
        'Ente'=>Array('projecttask','publicadminid'),
        'Data Presentazione'=> Array('projecttask', 'cf_657'),
        'Type'=>Array('projecttask','projecttasktype'),
        'Procedura'=>Array('projecttaskcf','cf_660'),
        'Assigned To' => Array('crmentity','smownerid')
    );
   ...
   function save_module($module) {
	...
	function get_history($id)
	{
		...
		return getHistory('ProjectTask',$query,$id);
	}
