...
$mod_strings = array (
  ...
  'LBL_DUPLICATE' => 'Cliente potenzialmente duplicata',
  'MSG_DUPLICATE' => 'Creando questa Cliente puoi potenzialmente creare un duplicato. Puoi o selezionare un Cliente dalla lista sottostante o cliccare su Crea Nuova Cliente per continuare creando una nuova Cliente con i dati precedentemente inseriti.',

  'LBL_INVITEE' => 'Contatti',
  'ERR_DELETE_RECORD' => 'Un numero di record deve essere specificato per cancellare l`Cliente',

  'LBL_SELECT_ACCOUNT' => 'Seleziona Cliente',
  ...
  'LBL_ACCOUNT_EXIST' => 'Il Nome Cliente esiste gia` !',
  ...
  'LBL_MAILER_EXPORT_RESULTS_DESCR' => 'I dati verranno raccolti dalle Clienti e dai loro Contatti, che sono stati restituiti dalla ricerca precedente.',
  'LBL_EXPORT_RESULTS_EMAIL' => 'Esporta i dati per E-Mailer',
  'LBL_EXPORT_RESULTS_EMAIL_CORP' => 'Esporta i dati per E-Mailer, usando E-mail dell`Cliente dalla scheda Cliente se il campo Email del Contatto &egrave;',
  'LBL_EXPORT_RESULTS_FULL' => 'Esporta i dati usando Contatti, E-Mail, Nome dell`Cliente, Indirizzo, Telefono, etc.',
...
'Account No' => 'Nr. Cliente',
'LBL_SHOW_ACCOUNT_HIERARCHY' => 'Mostra Gerarchia Clienti',

//crmv@510translation end
'LBL_SHOW_ACCOUNT_HIERARCHY' => 'Mostra Gerarchia Cliente',
'Projects' => 'Progetti',
//crmv@521translation end

'Accounts ID' => 'ID Cliente',
