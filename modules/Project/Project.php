...
class Project extends CRMEntity {
    ...
    // tablename should not have prefix 'vtiger_'
        ...
        'Ente'=>Array('project','publicadminid'),
		'Data Progetto'=> Array('vtiger_projectcf', 'cf_642'),
		'Autorizzazione N'=> Array('vtiger_projectcf', 'cf_643'),
		'Status'=>Array('project','projectstatus'),
		'Type'=>Array('project','projecttype'),
		'Assigned To' => Array('crmentity','smownerid')
    );
    var $list_fields_name = Array(
    /* Format: Field Label => fieldname danzi */
		'Project Name'=> 'projectname',
		'Related to'=> 'linktoaccountscontacts', 
		'Ente'=> 'publicadminid', 
		'Data Progetto'=> 'cf_642',
		'Autorizzazione N'=> 'cf_643',
