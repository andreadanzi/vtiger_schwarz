...
function getListQuery($module, $where = '') {
	...
	switch ($module) {
		...
		LEFT OUTER JOIN vtiger_project
	                ON vtiger_project.projectid = vtiger_seactivityrel.crmid
		LEFT OUTER JOIN vtiger_projecttask
	                ON vtiger_projecttask.projecttaskid = vtiger_seactivityrel.crmid
