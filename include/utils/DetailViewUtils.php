...
function getDetailViewOutputHtml($uitype, $fieldname, $fieldlabel, $col_fields, $generatedtype, $tabid='', $module='') {
	...
	if ($uitype == '10') {
        ...
        $value = $col_fields[$fieldname];
		$fieldValue = $value;
		$url_val = getRelatedSearchEntitiesUrl($module, $col_fields["record_id"], $value);
		$label_fld[] = getTranslatedString($fieldValue, $fieldValue);
		$label_fld["secid"] = $fieldValue;
		$label_fld["link"] = $url_val; // danzi.tn@20140324e
	} elseif ($uitype == 19) {
