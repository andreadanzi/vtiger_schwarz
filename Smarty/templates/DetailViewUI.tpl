					...
					{/foreach}
						...
						{elseif $keyid eq '116' || $keyid eq '117'} <!--ComboBox currency id edit only for admin Users-->
								...
								{/if}
											...
											{elseif $keyid eq '1017'} <!-- danzi.tn@20140324 Link To ListView-->
                                                  <td width=25% class="dvtCellInfo" align="left" id="mouseArea_{$label}" >&nbsp;<span id="dtlview_{$label}"><a href="{$keyseclink}">{$keyval}</a></span></td>
